...
export const sendTransaction = async (
  ...
  try {
    ...
    return { 
      tx_url: `https://testnet.arcscan.app/tx/${tx.hash}`,
      error: ""
    };
  } catch (error) {
    ...
    if (error instanceof Error) {
      ...
      if (errorText.includes("insufficient balance") || errorText.includes("signer had insufficient balance")) {
        errorMessage = "No USDC left, you can <a href='#' class='interactive-link' data-action='logout'>play as a guest</a> or <a href='#' class='interactive-link' data-action='faucet'>use Faucet</a>";
  ...
  try {
    ...
    try {
      ...
      if (balance < estimatedCost) {
        return { error: "No USDC left, you can <a href='#' class='interactive-link' data-action='logout'>play as a guest</a> or <a href='#' class='interactive-link' data-action='faucet'>use Faucet</a>" };
      }
